...
const VideoCoorporatePage = () => {
  return (
    <div className="w-100 h-100 text-gray">
      <div className="flex justify-center">
        <div className="client-details-container">
          <div>
            <div className="font-20 normal-font pb-2 text-white text-center">
              "2.5 SECONDS"
            </div>
          ...
          <div>
            <div className="font-20 normal-font pb-2 text-white text-center w-100">
              "2.5 SECONDS"
            </div>
            <div className="pb-2 content-font">
              <div className="pb-1">
